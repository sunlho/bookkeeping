...
class CustomCircleSymbolRenderer {
  ...
  //     canvas.drawRRect(Rectangle(left, top, maxWidth + 10, 26), fill: MaterialPalette.blue.shadeDefault, radius: Adaptor.px(6.0), roundTopLeft: true, roundBottomLeft: true, roundTopRight: true, roundBottomRight: true);

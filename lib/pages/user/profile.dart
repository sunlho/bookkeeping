...
class ProfileState extends State<ProfilePage> {
  ...
  Future<void> _uploadAvatar() async {
    var image = await new ImagePicker().pickImage(source: ImageSource.gallery);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('个人中心', style: TextStyle(fontSize: Adaptor.px(32.0), color: AppColors.appTextDark))),
      body: Container(
        child: Observer(
          builder: (_) => Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: _uploadAvatar,
                              child: Padding(
                                padding: EdgeInsets.only(right: Adaptor.px(12.0)),
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(Adaptor.px(30.0)),
                                  child: Image.network(

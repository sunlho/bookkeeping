...
class EditTaskState extends State<EditTaskPage> {
  ...
  void _getDetail() async {
    ...
    if (querySuccess) {
      TaskItem current = taskStore.current ?? TaskItem();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('编辑记账任务', style: TextStyle(fontSize: Adaptor.px(32.0), color: AppColors.appTextDark))),

...
class GroupDetailState extends State<GroupDetailPage> {
  ...
  void _disbandGroup() {
    BotToast.showAnimationWidget(
      ...
      toastBuilder: (cancelFunc) => AlertDialog(
        title: Text('您确定要解散此记账圈子吗?', style: TextStyle(fontSize: Adaptor.px(32.0), color: AppColors.appTextDark)),
        content: Padding(padding: EdgeInsets.only(top: Adaptor.px(20.0)), child: Text('解散后当前圈子里的用户账单将被转移至各自的个人记账圈子下', style: TextStyle(fontSize: Adaptor.px(26.0), color: AppColors.appTextDark))),
        actions: <Widget>[
          MaterialButton(
            onPressed: () {
              cancelFunc();
  ...
  void _exitGroup() {
    BotToast.showAnimationWidget(
      ...
      animationDuration: Duration(milliseconds: 300),
      toastBuilder: (cancelFunc) => AlertDialog(
        title: Text('您确定要退出此记账圈子吗?', style: TextStyle(fontSize: Adaptor.px(32.0), color: AppColors.appTextDark)),
        content: Padding(padding: EdgeInsets.only(top: Adaptor.px(20.0)), child: Text('退出后您在当前圈子里的账单将被转移至您的个人记账圈子下', style: TextStyle(fontSize: Adaptor.px(26.0), color: AppColors.appTextDark))),
        actions: <Widget>[
          MaterialButton(
            onPressed: () {
              cancelFunc();
      ...
      return Wrap(children: <Widget>[
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text('圈子类型', style: TextStyle(color: AppColors.appTextDark, fontSize: Adaptor.px(28.0))),
              Expanded(
                flex: 1,
                child: Align(
                  alignment: Alignment.centerRight,
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text('成员数量', style: TextStyle(color: AppColors.appTextDark, fontSize: Adaptor.px(28.0))),
              Expanded(
                flex: 1,
                child: Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    groupStote.current != null ? '${groupStote.current?.users?.length}' : '',
                    style: TextStyle(
                      color: AppColors.appTextNormal,
                      fontSize: Adaptor.px(28.0),
                      fontWeight: FontWeight.normal,
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text('管理员', style: TextStyle(color: AppColors.appTextDark, fontSize: Adaptor.px(28.0))),
              Expanded(
                flex: 1,
                child: Align(
                  alignment: Alignment.centerRight,
                  child: Text(
                    (groupStote.current != null && groupStote.current?.creator != null) ? '${groupStote.current?.creator?.nickName}' : '',
                    style: TextStyle(
                      color: AppColors.appTextNormal,
                      fontSize: Adaptor.px(28.0),
                      fontWeight: FontWeight.normal,
        ...
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text('默认圈子', style: TextStyle(color: AppColors.appTextDark, fontSize: Adaptor.px(28.0))),
              Expanded(
                flex: 1,
                child: Align(
                  alignment: Alignment.centerRight,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('记账圈子详情', style: TextStyle(fontSize: Adaptor.px(32.0), color: AppColors.appTextDark))),
      body: Container(
